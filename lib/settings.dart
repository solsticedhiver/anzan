  ...
  Widget build(BuildContext context) {
    ...
    return Scaffold(
      ...
      body: Center(
        ...
        SettingsSection(
            title: Text('Numbers', style: TextStyle(color: localGreen)),
            tiles: [
              CustomSettingsTile(
                  child: Container(
        ...
        SettingsSection(
            title: Text('Timings', style: TextStyle(color: localGreen)),
            tiles: [
              CustomSettingsTile(
                  child: Container(
                      padding: const EdgeInsets.only(top: 10, bottom: 10),
        ...
        SettingsSection(
            title:
                Text('Mode of operation', style: TextStyle(color: localGreen)),
            tiles: [
              ...
              SettingsTile.switchTile(
                ...
                description: const Text(
                    'Continue (with a pause) without checking answer'),
                onToggle: (value) {
                  setState(() {
        ...
        SettingsSection(
            title: Text('Text To Speech', style: TextStyle(color: localGreen)),
            tiles: [
              SettingsTile.switchTile(
        ...
        SettingsSection(
            title: Text('Theme', style: TextStyle(color: localGreen)),
            tiles: [
              SettingsTile.switchTile(
        ...
        SettingsSection(
            title: Text('Misc.', style: TextStyle(color: localGreen)),
            tiles: [
              SettingsTile(
