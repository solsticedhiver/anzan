    ...
    return Scaffold(
        ...
        body: Center(
            child: Container(
                ...
                width: min(550, MediaQuery.sizeOf(context).width),
                child: AppConfig.history.isEmpty
                    ? const Text(
                        'The history of the operations will be displayed here, once you have pressed the play button.')
                    : ListView.builder(
